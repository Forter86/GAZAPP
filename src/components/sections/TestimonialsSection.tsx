...
const testimonials: Testimonial[] = [
  ...
  {
    name: 'Бекчив Вадим Николаевич',
    position: 'Специалист по кадрам II категории',
    photo: vadimPhoto,
    text: 'Устроился в отдел кадров сразу после выпуска. Несмотря на отсутствие опыта, коллеги поддержали, наставник всё доходчиво объяснил, а руководство дало реальные задачи. Чувствую, что расту как специалист и приношу пользу компании. Выбор «Газпром трансгаз Сургут» считаю правильным.'
  },
  {
    name: 'Цыганова Анастасия Евгеньевна',
    position: 'Инженер по подготовке кадров II категории',
    photo: anastasiaPhoto,
    text: 'После университета сразу попала в дружную команду Учебно-производственного центра. Назначили внимательного наставника, помогли освоиться и поверить в свои силы. Работаю с обучением персонала — это и ответственно, и интересно. Очень довольна, что начала карьеру именно в «Газпром трансгаз Сургут»!'
  }
];
